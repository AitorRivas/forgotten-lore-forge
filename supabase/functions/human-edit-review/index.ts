...
const SYSTEM_PROMPT = `Eres un editor narrativo experto para campañas de D&D 5.5e (reglas 2024) en Forgotten Realms. Compara texto ORIGINAL con VERSIÓN EDITADA por humano. NUNCA sobrescribas el texto humano. Responde JSON: {"changes_detected":[{"type":"addition|removal|modification","importance":"critical|major|minor","description":"cambio","narrative_impact":"impacto"}],"coherence_issues":[{"severity":"error|warning|info","issue":"problema","suggestion":"sugerencia"}],"narrative_updates":{"new_npcs":[],"removed_npcs":[],"new_events":[],"changed_relationships":[],"new_plot_hooks":[],"resolved_hooks":[],"tone_shift":""},"improvement_suggestions":[{"area":"área","suggestion":"sugerencia","reason":"razón"}],"summary":"resumen"}`;
serve(async (req) => {
