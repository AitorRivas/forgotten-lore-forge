...
FORMATO JSON OBLIGATORIO:
{
  ...
  "description": "Premisa narrativa de 2-4 frases que enganche al DM. Describe el conflicto central, la amenaza y el tono.",
...
- La descripción debe ser una premisa jugable, no un resumen genérico.
- Elige región y tono que encajen narrativamente.
